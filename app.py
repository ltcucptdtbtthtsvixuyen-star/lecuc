...
<div class="main-header">
    ...
    <p>Tác giả: Lê Thị Cúc - Trường PTDTBT Tiểu học Thượng Sơn - ĐT: 0984 048 092</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 – Lê Thị Cúc - Trường PTDTBT Tiểu học Thượng Sơn - ĐT: 098 4048 092</div>", unsafe_allow_html=True)
